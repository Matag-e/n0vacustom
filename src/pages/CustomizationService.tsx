  ...
  const portfolio = [
    {
      ...
      image: "https://ejzimdctlmmeylmlfmvj.supabase.co/storage/v1/object/public/products/products/patro.jpeg",
      tag: "Patch Original"
    },
    {
      title: "Nomes e Números",
      image: "https://ejzimdctlmmeylmlfmvj.supabase.co/storage/v1/object/public/products/products/nome.jpeg",
      tag: "DTF"
    },
    {
      title: "Patches",
      image: "https://ejzimdctlmmeylmlfmvj.supabase.co/storage/v1/object/public/products/products/detalhes.jpeg",
      ...
      <section className="relative py-20 bg-zinc-950 text-white overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-20 pointer-events-none">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-primary/40 via-transparent to-transparent"></div>
                  <img src="/personaliza.jpeg" className="w-full h-full object-cover" alt="Hero" />
        </div>
