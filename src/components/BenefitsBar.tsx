      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-wrap justify-center gap-8 md:gap-16 lg:gap-24">
          {benefits.map((benefit, index) => (
            <div key={index} className="flex flex-col items-center text-center gap-3 group p-4 hover:bg-gray-50 dark:hover:bg-gray-900 rounded-lg transition-colors duration-300 min-w-[140px]">
